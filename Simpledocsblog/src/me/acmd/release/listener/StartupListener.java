package me.acmd.release.listener;
 ...
 */
@WebListener
public class StartupListener implements ServletContextListener, ServletContextAttributeListener, HttpSessionListener,
		HttpSessionAttributeListener, HttpSessionActivationListener, HttpSessionBindingListener, ServletRequestListener,
		HttpSessionIdListener, ServletRequestAttributeListener, AsyncListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		// TODO Auto-generated method stub
		PathKit.setPath(sce.getServletContext().getRealPath("/"));
		FileKit.scanNotConvert();
		Timer filer = new Timer();
		long delay = 60000L;
		filer.schedule(new TimerTask() {
			@Override
			public void run() {
				// TODO Auto-generated method stub
				Map<File, Long> docs = FileKit.scanNotConvert();
				FileKit.DOCX2HTM(docs);
